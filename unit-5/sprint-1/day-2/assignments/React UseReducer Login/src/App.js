    ...
    <div className="App">
      ...
      <form className="form-wrapper"  data-testid="form-wrapper" onSubmit={handleSubmit}>
        <div className="useremail-wrapper">
          ...
          <input type="email" value={state.email} data-testid="user-email" onChange={(e)=>dispatch({type:'email',payload:e.target.value})}/>
        </div>
        <div className="userpassword-wrapper">
          <label>User Password</label>
          <input type="password" value={state.password} data-testid="user-password" onChange={(e)=>dispatch({type:'password',payload:e.target.value})}/>
        </div>
