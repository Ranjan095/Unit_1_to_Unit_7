...
async function getProducts() {
 // 1. your code here.
 try{
let abc=await fetch("https://dbioz2ek0e.execute-api.ap-south-1.amazonaws.com/mockapi/get-tech-products");
let pro=await abc.json();
return pro.data;
 }catch(err){
  return "err"
 }
...
async function getWellFormattedData() {
 ...
 let res=product.reduce((acc,item)=>{
